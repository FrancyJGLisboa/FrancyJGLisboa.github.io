...
AQUASTAT - FAO Global's Water Statistics System is migrating its statistical processes into the Corporate Statistical Working System (SWS). This online book documents the major steps that have been taken so far in regard to this migration. The book describes the main institutional actors involved in the migration as well as the AQUASTAT - SWS resources (**code lists**, **datasets**, **data tables**) that have been created to support the SWS plugins (R modules) to meet technical unit requirements. Furthermore, the  The SWS plugins are presented in the form of Chapters providing detailed description of their workflows involving **inputs -> processing -> outputs** as well as results showing whether the modules have lived up expectations. 
