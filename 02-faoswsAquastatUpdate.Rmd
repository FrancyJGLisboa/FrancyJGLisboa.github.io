...
**FINAL REMARKS:**
The faoswsAquastatUpdate lives up to expectations by doing what it was maily designed for, i.e. update the aquastat_legacy dataset with new data coming from questionnaire and external datasources are available.
