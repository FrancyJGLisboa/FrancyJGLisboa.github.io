...
The **aquastat_legacy_corr** keeps the same dimension  names as the legacy dataset: **geographicAreaM49**, **aquastatElement**, **timePointYears**, **flagAquastat**, **flagAquastatVisibility**. 
