...
To avoid the manual download -> mapping -> upload  the module is also automatically harversting the FAOSTAT data from the FAOSTAT website. The FAOSTAT code to AQUASTAT code mapping is done by using the information stored in the **aquastat_faostat_mapping** data table.
